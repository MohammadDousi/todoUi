...
export default function ItemListTask(props) {
  ...
  return (
    <Link to={`/main/detailTask/${data?.id}`} className="w-full">
      <tr className="w-full py-4 px-6 flex jtify-center items-center gap-5 cursor-pointer duration-300 hover:bg-amber-50">
